...
onload = function() {
  ...
  function renderFrame(now) {
    ...
    const dotScale = eRange.value / 100 + 1.0;
    ...
    render(
        ...
        [mMatrix, mvpMatrix, invTMatrix, lightDirection, dotScale],
        ['mMatrix', 'mvpMatrix', 'invTMatrix', 'lightDirection', 'dotScale'], ['m4', 'm4', 'm4', 'v3', 'f1'], prg);
    render(
        [1.0, 1.0, 1.0], rad, [1, 1, 1], [2.0, 0, 0], [], trData.i.length,
        [mMatrix, mvpMatrix, invTMatrix, lightDirection, dotScale],
        ['mMatrix', 'mvpMatrix', 'invTMatrix', 'lightDirection', 'dotScale'], ['m4', 'm4', 'm4', 'v3', 'f1'], prg);
    render(
        [1.0, 1.0, 1.0], rad, [1, 1, 1], [-2.0, 0, 0], [], trData.i.length,
