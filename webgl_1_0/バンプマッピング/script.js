...
function renderWebGL() {
	...
	(function () {
		...
		render([1, 1, 1], rad, [0, -1, 0], [0, 0, 0], texture, earthData.i.length, [mMatrix, mvpMatrix, invTMatrix, lightPosition, camPosition, 0],
			['mMatrix', 'mvpMatrix', 'invTMatrix', 'lightPosition', 'eyePosition', 'texture'], ['m4', 'm4', 'm4', 'v3', 'v3', 'i1'], prg);
