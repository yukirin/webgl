...
onload = function() {
  ...
  const torusData = torus(64, 64, 0.10, 0.2, [1.0, 1.0, 1.0, 1.0]);
  ...
  function renderFrame(now) {
    ...
    render(
        [1.0, 1.0, 1.0], rad, [1, 1, 0], [0.0, 0.0, 0.0], [], torusData.i.length, trIndex,
        [
          mMatrix, mvpMatrix, invTMatrix, lightDirection, camPosition, [0.0, 0.0, 1.0, 1.0], [0.3, 0.2, 0.1, 1.0],
          [.0, 1., .0]
        ],
        [
          'mMatrix', 'mvpMatrix', 'invTMatrix', 'lightDirection', 'eyePosition', 'skyColor', 'groundColor',
          'skyDirection'
        ],
        ['m4', 'm4', 'm4', 'v3', 'v3', 'v4', 'v4', 'v3'], prg);

    render(
        [1.0, 1.0, 1.0], rad, [1, 1, 0], [0.6, 0.0, 0.0], [], torusData.i.length, trIndex,
        [
          mMatrix, mvpMatrix, invTMatrix, lightDirection, camPosition, [0.0, 0.0, 1.0, 1.0], [0.3, 0.2, 0.1, 1.0],
          [.0, 1., .0]
        ],
