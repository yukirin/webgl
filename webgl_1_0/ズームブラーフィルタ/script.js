...
onload = function() {
  ...
  const filterPrg = create_program('zoomblur.vert', 'x-vertex', 'zoomblur.frag', 'x-fragment');
  ...
  function renderFrame(now) {
    ...
    render(
        ...
        ['m4', 'm4', 'm4', 'v3', 'v3', 'v4'], prg);
    render(
        [1.0, 1.0, 1.0], rad, [1, 1, 0], [0.0, -1.0, -1.0], [], torusData.i.length, trIndex,
        [mMatrix, mvpMatrix, invTMatrix, lightDirection, camPosition, ambientColor],
        ['mMatrix', 'mvpMatrix', 'invTMatrix', 'lightDirection', 'eyePosition', 'ambientColor'],
        ['m4', 'm4', 'm4', 'v3', 'v3', 'v4'], prg);
    render(
    ...
    render(
        ...
        [mvpMatrix, 0, strength], ['mvpMatrix', 'texture', 'strength'], ['m4', 'i1', 'f1'], filterPrg);
