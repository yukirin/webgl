...
onload = function() {
  ...
  const spData = sphere(16, 16, 1.0);
  const vaos = {};
  vaos.sphere =
      createVAO([spData.p, spData.n, spData.c], ['position,3', 'normal,3', 'color,4'], [0, 0, 0], spData.i, prg);
  ...
  function renderFrame(now) {
    ...
    render(
        [1.0, 1.0, 1.0], rad, [1, 1, 1], [0, 0, 0], [], spData.i.length,
