...
onload = function() {
  ...
  const fBuffer2 = create_framebuffer(shadowMapSize, shadowMapSize, []);
  ...
  function renderFrame(now) {
    ...
    render(
        [1, 1, 1], Math.PI / 2, [1, 0, 0], [0, 0, 0], [textures[0]], planeData.i.length, pIndex,
        [mvpMatrix, 0, state, false, weight], ['mvpMatrix', 'texture', 'gaussian', 'horizontal', 'weight'],
        ['m4', 'i1', 'i1', 'i1', 'f1v'], filterPrg);
    ...
    render(
        [1, 1, 1], Math.PI / 2, [1, 0, 0], [0, 0, 0], [textures[0]], planeData.i.length, pIndex,
        [mvpMatrix, 0, state, true, weight], ['mvpMatrix', 'texture', 'gaussian', 'horizontal', 'weight'],
        ['m4', 'i1', 'i1', 'i1', 'f1v'], filterPrg);
